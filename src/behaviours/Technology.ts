...
export class Technology implements infoShowable {
    static allTechList: Technology[] = [
        ...
        new Technology(Tech.我来我见我征服, [Tech.探秘奥坎之径], 200, "每个政府等级提供的城市控制上限+1", [1]),
        new Technology(Tech.科技第一生产力, [Tech.探秘奥坎之径], 200, "解锁科技所需的科技点-15%", [-0.15]),
        ...
        // new Technology(Tech.科技再生产, [Tech.探秘奥坎之径, Tech.科技第一生产力], 200, "每拥有一项科技，所有地块基础产出+1", [0]),
        new Technology(Tech.战火狂潮之道, [], 100, "单位招募金钱花费-20%", [-0.2]),
        new Technology(Tech.下岗士兵再就业, [Tech.战火狂潮之道], 200, "招募单位所需的生产力-20%", [-0.2]),
        new Technology(Tech.配置士兵开拓车, [Tech.战火狂潮之道], 200, "所有士兵行动力上限+3", [3]),
        new Technology(Tech.先进作战机械, [Tech.战火狂潮之道], 200, "士兵战斗力提高+15%", [0.15]),
        new Technology(Tech.布置城防, [Tech.战火狂潮之道], 200, "当与敌方部队在己方领土发生战斗时，若省份为城市或与己方城市相邻，敌方部队掷骰时-1优势值", [-1]),
        ...
        new Technology(Tech.先进自走火炮, [Tech.战火狂潮之道, Tech.先进作战机械], 300, "解锁新兵种【自走火炮】：当该单位处于战斗状态时，使该场战斗己方部队掷骰时+1优势值", [1]),
        ...
        new Technology(Tech.浪淘尽现黄金, [Tech.奇迹工坊之路, Tech.发掘秘源之金], 300, "当前控制的所有地块金币产出+10", [10]),
